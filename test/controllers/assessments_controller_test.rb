...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { criteria_id: @assessment.criteria_id, name: @assessment.name, rang: @assessment.rang } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { criteria_id: @assessment.criteria_id, name: @assessment.name, rang: @assessment.rang } }
